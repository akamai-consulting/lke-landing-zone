...
func testsReachOutsideModule(dir string) (bool, error) {
	...
	err := filepath.WalkDir(dir, func(p string, d os.DirEntry, err error) error {
		...
		// "../../.." and not the package's exact depth: it is a SUBSTRING test, so
		// it still matches the deeper "../../../.." that the extensions/ and shared/
		// split introduced. Pinning the exact depth would have quietly stopped
		// flagging every package after that move.
