...
//
// FIFTH CAPABILITY, AND THE LAST GRANT WITHOUT ONE. `read-repo` is declared by 47
// of 67 extensions — more than any other grant — and until now it meant nothing at
