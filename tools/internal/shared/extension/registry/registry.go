...
var declarations = []func() extension.Extension{
	...
	dependabotcoverage.Extension,
	setupgosite.Extension,
	mutabletags.Extension,
	providerlock.Extension,
	upgradeplan.Extension,
...
// forty-one of the seventy-five — half of them: `assert-storage` lives in assertions/volumes,
