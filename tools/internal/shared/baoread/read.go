...
//     platform.DeliveredDocs and the bootstrap placeholder set (retired with validate-apl-values): the
...
// same call platform.DeliveredDocs and the bootstrap placeholder set (retired with validate-apl-values)
