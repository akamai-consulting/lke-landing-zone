...
// implementation.
//
// This is the second of the "two altitudes" established by ADR 0002
// (docs/adr/0002-llz-as-apl-cli.md). The APL layer (internal/apl) reaches
...
// code. ADR 0002 §Phase 3 hardens this interface from a seam into a
...
// Linode day-0 code in package main moves behind it; see ADR 0002 Appendix A.
