...
// A COPY of package main's fakeOrphanScanner — the preflight lane drives the same
// OrphanScanner interface. Copied rather than exported, the call this branch has
// made consistently: a fixture shared across an extraction boundary makes the
// extracted package a dependency of the CLI's own tests.
