...
// 6.1.0 release automation and has kept the convention since (v6.3.0 publishes as
// `version: v6.3.0`, tag `apl-v6.3.0`), and `helm --version 6.3.0` only resolves
...
func TestDefaultAplChartVersion(t *testing.T) {
	if clusterspec.BaselineAplChartVersion != "v6.3.0" {
		t.Errorf("clusterspec.BaselineAplChartVersion = %q, want \"v6.3.0\" — bump deliberately, in lockstep with the platform baseline", clusterspec.BaselineAplChartVersion)
	}
