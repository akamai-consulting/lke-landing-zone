...
func TempObjkeyCmd() *cobra.Command {
	c := &cobra.Command{
		Use:   "temp-objkey",
	...
	create := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return RunTempObjkeyCreate(region, endpoint, buckets)
		},
	}
	...
	del := &cobra.Command{
		...
		Args:  cobra.NoArgs,
		RunE:  func(_ *cobra.Command, _ []string) error { return RunTempObjkeyDelete() },
	}
...
func RotateBroadPATCmd() *cobra.Command {
	var apply bool
	c := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			return RunRotateBroadPAT(context.Background(), apply)
		},
	}
