...
//
// THE EMBEDDER HAS SINCE MOVED, and the const moved with it: the manifests were a
// `manifests/` directory in package main and are now in
// tools/internal/extensions/lifecycle/bootstrapcluster/manifests,
