...
//
// Found while reviewing an unrelated scope change (#559, withdrawn): the drift
// had been live long enough to break every CI-path rotation, and nothing said
// so, because the one test covering this invariant could only see one of the
// two declarations.
