...
//
// This is one of the "two altitudes" established by ADR 0013
// (docs/adr/0013-llz-as-apl-cli.md). The boundary rule: code here MUST NOT
...
// out of package main. See ADR 0013 Appendix A for the target package map.
package apl
