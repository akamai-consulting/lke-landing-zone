...
func TestRenderManifestKustomization(t *testing.T) {
	...
	// component dirs + a per-env patch (the reconciler env-patch, now that the
	// volume-labeler component + its region patch are retired).
	for _, want := range []string{
		"GENERATED by", "kind: Kustomization",
		"- ../../_shared/manifest",
		"- ../../components/externalSecrets",
		"- ../../components/harbor",
		"patches:", "path: llz-reconciler-env-patch.yaml", "kind: Deployment",
	} {
