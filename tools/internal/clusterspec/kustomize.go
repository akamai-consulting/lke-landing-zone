...
func RenderReconcilerEnvPatch(regionShort, region, objCluster, ghRepo string) string {
	return "# GENERATED by `llz render` — the per-env REGION_SHORT (volume-labels),\n" +
		"# REGION/OBJ_CLUSTER (linode-creds) + GH_REPO (apl-overlay) for the llz reconciler.\n" +
		`apiVersion: apps/v1
kind: Deployment
metadata:
  name: llz-reconciler
