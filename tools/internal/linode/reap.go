...
// VolumeIsCandidate is the SCOPE filter for a destructive Volume sweep: an
...
//
// Scope only — it answers "is this Volume in the set I was asked to consider?",
// NOT "is it an orphan?". The cluster-liveness gate that distinguishes a live
// cluster's detached Volume from a true orphan is ClassifyVolume, which the caller
