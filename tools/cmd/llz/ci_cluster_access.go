...
// ci_cluster_access.go — the kubeconfig and runner-ACL verbs, reduced to flag sets.
//
...
func clusterAccessDeps() clusteraccess.Deps {
	return clusteraccess.Deps{Exec: execOutput}
}

func ciRunnerACLCmd() *cobra.Command {
	var o clusteraccess.ACLOpts
	c := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return clusteraccess.RunACL(clusterAccessDeps(), args[0], o)
		},
	}
	f := c.Flags()
...
func ciFetchKubeconfigCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error { return clusteraccess.RunFetch(o) },
	}
	f := c.Flags()
...
func ciFetchKubeconfigStateCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return clusteraccess.RunFetchFromState(clusterAccessDeps(), region, output, allowMissing)
		},
	}
