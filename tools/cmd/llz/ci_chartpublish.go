...
// ci_chartpublish.go — the `llz ci chart-publish-check` flag set.
//
// The check is tools/internal/chartpublish, which declares the extension. What
...
func ciChartPublishCheckCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return chartpublish.Run(chartpublish.Defaults(chartpublish.Opts{
