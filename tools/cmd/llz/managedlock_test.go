...
func TestManagedFreshLocksEveryManagedFileNotJustGithub(t *testing.T) {
	dir := freshFixture(t)
	if err := sustain.RunManagedFresh(sustainDeps(), "", true, io.Discard, io.Discard); err != nil {
		t.Fatal(err)
	}
...
func TestManagedFreshPassesCleanAndFailsOnEdit(t *testing.T) {
	...
	if err := sustain.RunManagedFresh(sustainDeps(), "", false, io.Discard, io.Discard); err != nil {
	...
	err := sustain.RunManagedFresh(sustainDeps(), "", false, io.Discard, io.Discard)
	if err == nil {
...
func TestManagedFreshCatchesAManagedFileMissingFromTheLock(t *testing.T) {
	...
	if err := sustain.RunManagedFresh(sustainDeps(), "instance-template", true, io.Discard, io.Discard); err != nil {
		t.Fatal(err)
	}
	if err := sustain.RunManagedFresh(sustainDeps(), "instance-template", false, io.Discard, io.Discard); err != nil {
	...
	err := sustain.RunManagedFresh(sustainDeps(), "instance-template", false, io.Discard, io.Discard)
	if err == nil {
...
func TestManagedFreshCountsMissingAndDriftedTogether(t *testing.T) {
	...
	err := sustain.RunManagedFresh(sustainDeps(), "", false, io.Discard, &errOut)
	if err == nil {
