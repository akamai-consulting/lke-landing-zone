...
// ci_manifestguard.go — the three `guard-manifests` flag sets.
//
// The guards are tools/internal/manifestguard, which declares the extension.
// What stays here is the cobra wiring and the help text for each.
...
func ciArgoCDRenderedAppsCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			return manifestguard.RunArgoCDRenderedApps(filepath.Join(root, renderDir), os.Stdout)
		},
	}
...
func ciAplSchemaValidateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error {
			return manifestguard.RunValidateAplValues(valuesPath, chartVersion, skipSchema)
		},
	}
...
func ciPlaceholderGuardCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			return manifestguard.RunPlaceholderGuard(dir)
		},
	}
