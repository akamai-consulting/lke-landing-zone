...
// ci_baocredflagsets.go — the flag sets for the three credential verbs that
...
func ciRotateInclusterPATCmd() *cobra.Command {
	return &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error { return credrotate.RunRotateInClusterPAT() },
	}
}
...
func ciMintBootstrapPATCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error { return credrotate.RunMintBootstrapPAT(region) },
	}
...
func ciMintBootstrapObjkeysCmd() *cobra.Command {
	...
	c := &cobra.Command{
		...
		Args: cobra.NoArgs,
		RunE: func(_ *cobra.Command, _ []string) error { return credrotate.RunMintBootstrapObjkeys(region) },
	}
