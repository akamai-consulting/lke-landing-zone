...
func ciCmd() *cobra.Command {
	...
	c.AddCommand(ciTFImportCmd(), ciTFApplyCmd(), tofudriver.PlanCmd(), tofudriver.OutputCmd(), tofudriver.DestroyCmd(), teardown.ReapVolumesCmd(), teardown.ReapNodeBalancersCmd(), teardown.ReapObjKeysCmd(),
