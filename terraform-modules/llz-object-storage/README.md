...
> (llz-bootstrap-openbao.yml) and seeded straight into OpenBao, and the in-cluster
...
Extracted from the `object-storage` root config — now generated by `llz render`
from [`../../tools/internal/shared/tfroots/roots/object-storage/`](../../tools/internal/shared/tfroots/roots/object-storage/) —
so a sibling system team can provision the same registry/telemetry storage by
setting values instead of copying YAML. The operational scars travel with the module:
...
See [`terraform-modules/RELEASING.md`](../RELEASING.md) for the tag/version contract.
