...
**Related:** your observability configuration (dashboards, metrics topology), [`grafana-values.yaml`](../../instance-template/apl-values/example/values.yaml).
...
The two data sources today are Prometheus and Loki, both configured declaratively in [`grafana-values.yaml`](../../instance-template/apl-values/example/values.yaml). For a new data source:
