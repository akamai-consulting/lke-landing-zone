...
**71 extensions across 70 packages** declare **124 bindings** between them. The set is not enumerated
...
**That condition has since been met, and the observation disagrees.** 71 extensions now declare their
