...
**73 extensions across 72 packages** declare **127 bindings** between them. The set is not enumerated
...
**That condition has since been met, and the observation disagrees.** 73 extensions now declare their
