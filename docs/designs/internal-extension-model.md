...
**72 extensions across 71 packages** declare **126 bindings** between them. The set is not enumerated
...
**That condition has since been met, and the observation disagrees.** 72 extensions now declare their
