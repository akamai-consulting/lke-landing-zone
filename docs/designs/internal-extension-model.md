...
**69 extensions across 68 packages** declare **123 bindings** between them. The set is not enumerated
...
**That condition has since been met, and the observation disagrees.** 69 extensions now declare their
