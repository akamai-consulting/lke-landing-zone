...
`tools/internal/extensions/lifecycle/converge/health.go`, `docs/designs/kube-native-reconciler.md`,
...
throughout ([ci_health.go](../../tools/internal/extensions/lifecycle/converge/health.go): `kubectlReachable()`,
