...
| [internal-extension-model](internal-extension-model.md) | Phase 1 — the declaration model (`tools/internal/extension`: states, bindings, grants, validation) landed and is **wired to nothing**. Registry, loader, CI codegen and the remote half did not; issue #399 sequences them. |
